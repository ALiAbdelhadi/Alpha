   ...
   return (
      <div>
         <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <motion.div
               className="col-span-full overflow-hidden rounded-xl bg-gradient-to-r from-purple-50 via-purple-400 to-purple-900 dark:from-purple-950 dark:via-purple-800 dark:to-purple-900 px-4 sm:px-6 lg:px-8 py-6 lg:py-24"
            ...
            >
               <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 lg:p-4 p-0">
                  <div className="relative w-full lg:w-1/2">
                     <div className="backdrop-blur-lg bg-white/20 dark:bg-gray-800/30 text-gray-100 p-4 sm:p-6 md:p-8 rounded-3xl">
                        <CodeView
    ...
    <ActionPanel title={props.pullRequest.id}>
      ...
      <ActionPanel.Section title="Copy">
        ...
        <CopyBranchAction pullRequest={props.pullRequest} />
                     ...
                     <div className="absolute top-1/2 left-[10%] md:left-[25%] lg:left-1/2 lg:-translate-x-1/4 -translate-x-[10%] lg:-translate-y-1/4 translate-y-[28%] bg-gradient-to-r from-[rgba(245,245,247,0.1)] to-gray-700/30 dark:from-gray-800/20 dark:to-gray-900/40 backdrop-blur-lg w-[100%] md:w-[50%] lg:w-[65%] z-50 shadow-sm rounded-xl ml-0 lg:ml-32">
                        ...
                        <div className="p-2 space-y-2">
                           <div
                              className="px-2 py-1 hover:bg-gray-500/20 dark:hover:bg-gray-700/40 rounded-lg flex items-center justify-between cursor-pointer transition-colors"
                           >
                              <div className="flex items-center gap-2">
                                 <ArrowUpRight className="w-4 h-4 text-gray-400" />
                                 <span className="text-sm text-gray-200">View Pull Request</span>
                              </div>
                              <div className="text-xs text-gray-100 backdrop-blur-lg bg-purple-600/10 dark:bg-purple-800/20 shadow rounded-md p-2">
                                 <HiMiniArrowTurnDownLeft size={20} />
                              </div>
                           </div>
                           <div
                              className="p-2 hover:bg-gray-500/20 dark:hover:bg-gray-700/40 rounded-lg flex items-center justify-between cursor-pointer transition-colors"
                           >
                              <div className="flex items-center gap-2">
                                 <ArrowUpRight className="w-4 h-4 text-gray-400" />
                  ...
                  <div className="space-y-4 text-center lg:text-left w-full lg:w-1/2 lg:ml-20 ml-0 md:mt-0 mt-6">
                     ...
                     <p className="text-base md:text-lg text-purple-200 dark:text-purple-100">
                     ...
                     <p className="text-purple-200 dark:text-purple-100 text-base md:text-lg">
                     ...
                     <Link
                        ...
                        target="_blank"
                        className="bg-purple-900 hover:bg-purple-950 dark:bg-purple-800 dark:hover:bg-purple-700 text-white font-semibold py-3 px-4 rounded-md inline-block"
                     >
            ...
            {/* Open Source Card */}
            <motion.div
               className="border border group relative overflow-hidden rounded-xl p-8 md:col-span-2 bg-background shadow hover:shadow-md transition-shadow"
               variants={ANIMATION_VARIANTS}
               initial="initial"
               animate="animate"
            >
               <div className="space-y-8 hover:translate-x-1 transition-transform">
                  <div className="flex lg:items-center items-start justify-between lg:flex-row flex-col lg:space-x-6 space-x-0 space-y-6 lg:space-y-0">
                     ...
                     <div className="relative space-y-6 ml-6">
                        <div className="absolute left-[4.8px] top-0 h-full w-[2px] bg-gray-200 dark:bg-gray-700" />
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                           <div className="h-3 w-3 rounded-full bg-green-100 dark:bg-green-800 z-50" />
                           <div className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded-full">
                              User A contributed to the project.
                           </div>
                        </div>
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                           <div className="h-3 w-3 rounded-full bg-blue-100 dark:bg-blue-800 z-50" />
                           <div className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded-full">
                              User B forked the repository.
                           </div>
                        </div>
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                           <div className="h-3 w-3 rounded-full bg-purple-100 dark:bg-purple-800 z-50" />
                           <div className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded-full">
            ...
            {/* Story Card */}
            <motion.div
               className="border group relative overflow-hidden rounded-xl bg-card p-8 shadow hover:shadow-md transition-shadow"
               variants={ANIMATION_VARIANTS}
               initial="initial"
               animate="animate"
            >
            ...
            <motion.div
               className="border group relative overflow-hidden rounded-xl bg-card p-8 md:col-span-2 shadow hover:shadow-md transition-shadow"
               variants={ANIMATION_VARIANTS}
               initial="initial"
               animate="animate"
            >
