...
export const CarouselProject = ({ items, initialScroll = 0, cardGap = 16, scrollOffset: initialScrollOffset, initialActiveIndex = 1 }: CarouselProps) => {
   ...
   useEffect(() => {
      if (carouselRef.current && initialActiveIndex !== undefined) {
         const itemWidth = carouselRef.current.offsetWidth - 260
   ...
   return (
      <Fragment>
         <motion.div
            ...
            className="rounded-3xl cursor-pointer bg-gray-100 dark:bg-neutral-900 h-72 md:h-[33rem] w-[35vh] sm:w-[50vh] md:w-[90vh] lg:w-[110vh] xl:w-[150vh] overflow-hidden flex flex-col items-start justify-start relative z-10 shadow border-[#f0eef1]"
         >
