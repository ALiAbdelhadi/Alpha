...
export function ActionMenuItem({ icon, text, shortcut }) {
  return (
    <div className="px-3 py-2 hover:bg-purple-700/20 rounded-md flex items-center justify-between cursor-pointer transition-colors">
